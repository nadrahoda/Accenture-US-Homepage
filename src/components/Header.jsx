...
const Header = () => {
  ...
  const [flyerFour, setFlyerFour] = useState(false);
  const [flyerFive, setFlyerFive] = useState(false);
  const [country, setCountry] = useState(false);

  return (
    <>
      <div className="relative bg-black pt-4">
          ...
          <div className="flex justify-between items-center    md:justify-start md:space-x-10">
            <div className="flex justify-start lg:w-0 lg:flex-1">
              <a href="#" className="">
                ...
                <Image
                  alt="not found"
                  className="h-10 w-32  border-b-4 m-2 border-black "
                  src={logo}
                />
              </a>
            </div>
            ...
            <nav className=" hidden md:flex space-x-10 ">
              <div className="relative">
                <button
                  type="button"
                  className="
                     group bg-black   rounded-md  inline-flex items-center text-base   focus:outline-none   pb-8'
                    "
                  onClick={() => (
                    setFlyer(!flyer),
                    setFlyerTwo(false),
                ...
                >
                  <span
                    className={`hover:border-b-4 border-b-4 border-black  pb-4  pt-4 w-20 ${
                      flyer == true ? "text-gray-400" : "text-white"
                    }`}
                  >
                    Insights
                  </span>
              ...
              <div className="relative">
                <button
                  type="button"
                  className="
                     group bg-black rounded-md  inline-flex items-center text-base   hover:text-white focus:outline-none  focus:ring-indigo-500 pb-8'
                    "
                  onClick={() => (
                    setFlyerThree(!flyerThree),
                    setFlyerTwo(false),
                    setFlyer(false),
                    setFlyerFour(false),
                    setFlyerFive(false)
                ...
                >
                  <span
                    className={`hover:border-b-4 border-b-4 border-black  pb-4  pt-4 w-20 ${
                      flyerThree == true ? "text-gray-400" : "text-white"
                    }`}
                  >
                    Careers
                  </span>
              ...
              <div className="relative">
                {/* Item active: "text-white", Item inactive: "text-gray-500" */}
                <button
                  type="button"
                  className="
                     group bg-black rounded-md  inline-flex items-center text-base   hover:text-white  pb-8'
                    "
                  onClick={() => (
                    setFlyerFour(!flyerFour),
                    setFlyerTwo(false),
                    setFlyerThree(false),
                    setFlyer(false),
                    setFlyerFive(false)
                ...
                >
                  <span
                    className={`hover:border-b-4 border-b-4 border-black  pb-4  pt-4 w-20 ${
                      flyerFour == true ? "text-gray-400" : "text-white"
                    }`}
                  >
                    Services
                  </span>
              ...
              */}
                ...
                <div
                  onMouseLeave={() => setFlyerFour(false)}
                  className={
                    flyerFour
                      ? " opacity-100 translate-y-0 transition ease-out duration-200 absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2"
                      : " opacity-0 translate-y-1 absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2"
              ...
              <div className="relative">
                ...
                >
                  <span
                    className={`hover:border-b-4 border-b-4 border-black  pb-4  pt-4 w-20 ${
                      flyerFive == true ? "text-gray-400" : "text-white"
                    }`}
                  >
                    Industries
                  </span>
              ...
              */}
                ...
                <div
                  onMouseLeave={() => setFlyerFive(false)}
                  className={
                    flyerFive
                      ? " opacity-100 translate-y-0 transition ease-out duration-200 absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2"
                      : " opacity-0 translate-y-1 absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2"
              ...
              <div className="relative ">
                ...
                <button
                  type="button"
                  className="group  bg-black rounded-m inline-flex items-center text-base hover:text-white "
                  onClick={() => (
                ...
                >
                  <span
                    className={`hover:border-b-4 border-b-4 border-black  pb-4  pt-4 w-32 ${
                      flyerTwo == true ? "text-gray-400" : "text-white"
                    }`}
                  >
                    About Accenture
                  </span>
            ...
            <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              <Image className="mr-2 w-8 h-8 	" alt="" src={search} />
              ...
              <div className="relative">
                ...
                >
                  <span
                    className={`hover:border-b-4 border-b-4 border-black  pb-4  pt-4 w-20 ${
                      country == true ? "text-gray-400" : "text-white"
                    }`}
                  >
                    USA
                  </span>
